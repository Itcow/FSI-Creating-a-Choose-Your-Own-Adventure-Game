...
if (secondAnswer === 'treasure') {
    ...
    if(secondAnswer === 'stay') {
        ...
        if(secondAnswer === 'draw it') {
            ...
            let secondAnswer = window.alert("You pick the flower and bring it home, and all marvel at its brilliance. However, over time it fades and eventually crumbles to dust.")
        }
    }
}